        ...
        >
            ...
            <MapContainer
              components={[
                ...
                },
                {
                  buttonText: 'Map',
                  component: (
                    <InternetAccessMap newWidth={700} newHeight={550} />
                  )
                }
              ]}
            />
          ...
          >
            ...
            <p>
              ...
              internet has spread, becoming today a tool within everyone's
              reach.
            </p>
          </ChartContainer>
        </ChartSection>
        ...
        >
          <ChartHeading>
            ...
            <p>
              ...
              have internet at home, let's try to investigate why these people
              do not have internet. This faceted bar chart shows the results of
              a survey conducted annually until 2019 regarding the reasons why
              an individual does not have an internet connection at home, the
              expected answers in the survey were the following: access costs
              are too high (telephone, etc.), broadband is not available in the
              area, access elsewhere, equipment costs are too high, access not
              needed (content is not useful, interesting, etc.), other reasons,
              privacy or security concerns and lack of skills.
            </p>
          </ChartHeading>
          <ChartBody>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              very low levels, suggesting almost universal Internet use in many
              EU nations. There is a very important aspect to highlight and we
              will do so by taking Italy as an example: from 2005 to 2024 the
              percentage of people who have never used the Internet has
              decreased by almost 50%. This also allows us to understand the
              importance of educating the population in the use of these new
              technologies, given the short time interval that many users have
              had to familiarize themselves with it.
            </p>
          </ChartContainer>
        </ChartSection>
