    ...
    <div>
      ...
      <AssignmentPage title={'Use of the Internet'}>
        ...
        >
          <ChartHeading>
            ...
            <p>
              ...
              in the last 3 months, never, more than a year ago, and between 3
              and 12 months ago. <br></br>
          ...
          >
            ...
            <p>
              ...
              group, which is also the most numerous demographic in the country.{' '}
              <br></br>
        ...
        >
          <ChartHeading>
            ...
            <p>
              ...
              selector allows users to choose the country they want to analyze.
            </p>
          </ChartHeading>
          <ChartBody>
          ...
          >
            ...
            <p>
              ...
              across the EU, we notice a steady increasing trend from 2013 to
              2024 in the percentage of individuals engaging in social network
              activities, searching for information about goods and services ,
              and selling goods and services. This upward trend suggests a
              growing reliance on digital platforms for both social interactions
        ...
        >
          <ChartHeading>
            ...
            <p>
              ...
              below. The idea is to merge two datasets from EUROSTAT to
              determine the percentage of individuals investing and what they
              invest in , depending on the country. <br></br>
              ...
              where the bubble size represents the ratio between the percentage
              of investors and the country's population, highlighting which
              countries contribute the most in absolute numbers. <br></br>
              ...
              intuitive representation of financial engagement across different
              nations and years. This chart ultimately aims to illustrate which
              country, in which year, had the highest number of individuals
              actively participating in the financial market.
            </p>
          </ChartHeading>
          <ChartBody>
            <ChartContainer
          ...
          >
            ...
            <p>
              ...
              largest bubbles, despite having fewer absolute investors compared
              to other countries. This is due to the fact that, in terms of
              percentage, Sweden had the highest proportion of its population
              participating in financial investments that year. The chart
              effectively highlights how a country's investment activity can be
              significant not only in raw numbers but also in relation to its
              total population.
            </p>
          </ChartContainer>
        </ChartSection>
        ...
        >
          <ChartHeading>
            ...
            <p>
              ...
              for key attributes: the basis of discrimination, the percentage of
              the population which has been effectively discriminated and the
          ...
          >
            ...
            <p>
              ...
              they have encountered degrading or discriminatory messages online
              targeting a group of people in the last three months.
              Additionally, looking at the last stacked chart, it can be
              observed that among these people, 25.37% believed that the attacks
              were due to religious opinions or beliefs.
            </p>
          </ChartContainer>
        </ChartSection>
        {/* BAR CHART - PURCHASE */}
        ...
        >
          <ChartHeading>
            <ChartH1Title>
              Percentage of individual that purchase online in the last 3 month
              of the year in the Europe Continent from 2010 to 2024
            </ChartH1Title>
            <p>
              ...
              consolidates data from two separate CSV files into a single,
              unified file. This final dataset provides the percentage of
              individuals who made an online purchase in the last three months
              across European countries, covering the period from 2010 to 2024.
              The data is organized by country and year, enabling easy analysis
              of trends over time. By merging the two sources, we ensure
              continuity in tracking the evolution of online purchasing behavior
              before and after 2019, offering a comprehensive view of digital
              commerce adoption across Europe.
            </p>
          </ChartHeading>
          <ChartBody>
            <Purchase></Purchase>
          ...
          >
            ...
            <p>
              ...
              2010 to nearly 40% in 2024. This growth can be attributed to
              several factors, including increased internet penetration,
              improved digital literacy, and the growing availability of
              e-commerce platforms. In earlier years, fewer people had internet
              access, and online shopping was less widespread. However, as
              digital services expanded and became more accessible, a larger
              portion of the population started purchasing goods and services
              online. In recent years, this growth appears to have reached a
              plateau around 40%, suggesting that most of the population willing
              and able to shop online has already transitioned, with further
              increases likely happening at a slower rate .
            </p>
          </ChartContainer>
        </ChartSection>
      </AssignmentPage>
