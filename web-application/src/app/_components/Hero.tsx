export default function Hero() {
  return <section className="min-h-dvh flex flex-col p-6">
    <div className="flex justify-center mt-36 sm:mt-[20%]"> 
      <div className="w-fit">
        <h1 className="text-6xl sm:text-8xl lg:text-[10rem] font-serif font-semibold md:font-bold">IncApache</h1>
