...
DATASET_PATH = os.path.join(
    os.getcwd(), "../original-datasets/individual-level-of-digital-skills-2019.csv"
)
...
indic_is_rename = {
    "Individuals who have above basic overall digital skills": "Individuals with above basic overall digital skills",
    "Individuals who have basic or above basic overall digital skills": "Individuals with basic or above basic overall digital skills",
    "Individuals who have basic overall digital skills": "Individuals with basic overall digital skills",
    "Individuals who have low overall digital skills": "Individuals with low overall digital skills",
    "Individuals who have no overall digital skills": "Individuals with no overall digital skills",
}
